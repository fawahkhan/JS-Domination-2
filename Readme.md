...
- Hooking `click`, `change`, and `keydown` listeners on DOM nodes and `window`.
- Preventing default form submits to keep the page alive.
- Creating and styling elements on the fly with vanilla JS.
